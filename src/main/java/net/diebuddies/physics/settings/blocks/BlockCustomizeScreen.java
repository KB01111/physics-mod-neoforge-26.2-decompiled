...
public class BlockCustomizeScreen extends LegacyOptionsSubScreen {
   ...
   protected void init() {
      this.list = new BlockSelectionList(
         ...
         this.height - 32,
         25,
         block -> this.minecraft.setScreenAndShow(new BlockEditScreen(this, this.options, block))
      );
            ...
            button -> PopupWidget.create(
                  ...
                  response -> {
                     if (response == PopupWidget.PopupResponse.YES) {
                        ...
                        this.minecraft.setScreenAndShow(new BlockSettingsScreen(this.lastScreen, this.options));
                     }
                  }
               )
         )
