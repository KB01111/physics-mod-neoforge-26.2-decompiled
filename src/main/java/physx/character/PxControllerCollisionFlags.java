...
public class PxControllerCollisionFlags extends NativeObject {
   ...
   public static <T> PxControllerCollisionFlags createAt(T allocator, NativeObject.Allocator<T> allocate, byte flags) {
   ...
   private static native void __placement_new_PxControllerCollisionFlags(long var0, byte var2);

   public PxControllerCollisionFlags(byte flags) {
      this.address = _PxControllerCollisionFlags(flags);
   }

   private static native long _PxControllerCollisionFlags(byte var0);
