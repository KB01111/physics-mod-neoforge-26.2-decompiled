...
public class PxArray_PxShapePtr extends NativeObject {
   ...
   public static PxArray_PxShapePtr createAt(long address) {
      __placement_new_PxArray_PxShapePtr(address);
      PxArray_PxShapePtr createdObj = wrapPointer(address);
   ...
   private static native void __placement_new_PxArray_PxShapePtr(long var0);

   public static PxArray_PxShapePtr createAt(long address, int size) {
      __placement_new_PxArray_PxShapePtr(address, size);
      PxArray_PxShapePtr createdObj = wrapPointer(address);
      createdObj.isExternallyAllocated = true;
      return createdObj;
   }
   ...
   private static native void __placement_new_PxArray_PxShapePtr(long var0, int var2);

   public PxArray_PxShapePtr() {
      this.address = _PxArray_PxShapePtr();
   }

   private static native long _PxArray_PxShapePtr();

   public PxArray_PxShapePtr(int size) {
      this.address = _PxArray_PxShapePtr(size);
   }

   private static native long _PxArray_PxShapePtr(int var0);
   ...
   public PxShape get(int index) {
      this.checkNotNull();
      return PxShape.wrapPointer(_get(this.address, index));
   }
   ...
   public PxShapePtr begin() {
      this.checkNotNull();
      return PxShapePtr.wrapPointer(_begin(this.address));
   }
