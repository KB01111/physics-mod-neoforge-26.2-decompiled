...
public class Vector_PxActorPtr extends NativeObject {
   ...
   public PxActor at(int index) {
      this.checkNotNull();
      return PxActor.wrapPointer(_at(this.address, index));
   }
   ...
   public PxActorPtr data() {
      this.checkNotNull();
      return PxActorPtr.wrapPointer(_data(this.address));
   }
