...
public class Vector_PxVec4 extends NativeObject {
   ...
   public PxVec4 at(int index) {
      this.checkNotNull();
      return PxVec4.wrapPointer(_at(this.address, index));
   }
   ...
   public PxVec4 data() {
      this.checkNotNull();
      return PxVec4.wrapPointer(_data(this.address));
   }
